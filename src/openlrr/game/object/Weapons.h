...
// <LegoRR.exe @0046f530>
#define Weapon_LegoObject_FUN_0046f530 ((void (__cdecl* )(LegoObject* liveObj, sint32 weaponID, bool32 unkSlowDeathBool, real32 param_4, const Point2F* dir))0x0046f530)

// <LegoRR.exe @0046f640>
#define Weapon_LegoObject_FUN_0046f640 ((void (__cdecl* )(LegoObject* liveObj, real32 damage, bool32 param_3))0x0046f640)

// Probably projectile hitting an object and the projectile object being removed.
// Along with effects of weapon hitting.
// <LegoRR.exe @0046f670>
#define Weapon_Struct2B0_FUN_0046f670 ((void (__cdecl* )(Struct_2b0* struct2b0))0x0046f670)
...
// <LegoRR.exe @0046fa30>
#define Weapon_LegoObject_FUN_0046fa30 ((void (__cdecl* )(LegoObject* liveObj, const Vector3F* dirVec2D, OPTIONAL const Vector3F* worldPos, sint32 weaponID, WeaponKnownType knownWeapon))0x0046fa30)

// <LegoRR.exe @0046fbe0>
#define Weapon_Struct2B0_FUN_0046fbe0 ((void (__cdecl* )(Struct_2b0* struct2b0, real32 elapsed))0x0046fbe0)

// <LegoRR.exe @0046fdb0>
#define Weapon_Struct2B0_FUN_0046fdb0 ((bool32 (__cdecl* )(LegoObject* liveObj, const Vector3F* param_2, const Vector3F* param_3, uint32 weaponID, WeaponKnownType knownWeapon))0x0046fdb0)

// <LegoRR.exe @0046ff30>
#define Weapon_UpdateRoutingUnk_FUN_0046ff30 ((bool32 (__cdecl* )(LegoObject* liveObj, const Vector3F* param_2, const Vector3F* param_3, sint32 param_4, WeaponKnownType knownWeapon))0x0046ff30)
...
// <LegoRR.exe @00470270>
#define Weapon_DoLaserUnk_FUN_00470270 ((LegoObject* (__cdecl* )(const Vector3F* sndPosition, const Vector3F* param_2, LegoObject* liveObj, real32 elapsed, real32 weaponRange, sint32 weaponID, real32 coef))0x00470270)
...
// <LegoRR.exe @00470950>
#define Weapon_ItemStruct34_FUN_00470950 ((void (__cdecl* )(Gods98::Container* cont, const Vector3F* vector1, const Vector3F* vector2))0x00470950)

// <LegoRR.exe @00470a20>
#define Weapon_Struct34_FUN_00470a20 ((void (__cdecl* )(Gods98::Mesh* mesh, real32 scalar, const Vector3F* vector1, const Vector3F* vector2, real32 red, real32 green, real32 blue, real32 alpha))0x00470a20)
...
// <LegoRR.exe @00471d20>
#define Weapon_UnkStruct_FUN_00471d20 ((void (__cdecl* )(WeaponsModel* weapons, const Vector3F* vector68, real32 param_3, bool32 assignVectors68, uint32 frameNo))0x00471d20)
...
// <LegoRR.exe @00471fe0>
#define Weapon_LegoObject_FUN_00471fe0 ((bool32 (__cdecl* )(LegoObject* liveObj, real32 elapsed, uint32 frameNo))0x00471fe0)

// <LegoRR.exe @004721c0>
#define Weapon_LegoObject_FUN_004721c0 ((bool32 (__cdecl* )(LegoObject* liveObj, real32 elapsed, uint32 frameNo))0x004721c0)
