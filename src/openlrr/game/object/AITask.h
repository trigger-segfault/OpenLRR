...
using AITask_ListSet = ListSet::Collection<AITask_Globs>;
...
// <LegoRR.exe @00401f40>
#define AITask_FUN_00401f40 ((void (__cdecl* )(AITask_Type taskType, LegoObject* liveObj, OUT Point2I* blockPos))0x00401f40)
...
//// <LegoRR.exe @00402140>
//#define free2 ((void (__cdecl* )(undefined* param_1))0x00402140)
...
// <LegoRR.exe @004027c0>
#define AITask_DoTrain_Target ((void (__cdecl* )(LegoObject* targetObj, LegoObject_AbilityFlags training, bool32 param_3))0x004027c0)
...
// <LegoRR.exe @004029a0>
#define AITask_Callback_IfAttackPath_FUN_004029a0 ((bool32 (__cdecl* )(AITask* aiTask, const Point2I* const* search))0x004029a0)

// <LegoRR.exe @004029d0>
#define AITask_LiveObject_DoCallbacks_FUN_004029d0 ((bool32 (__cdecl* )(LegoObject* liveObj))0x004029d0)

// <LegoRR.exe @004029f0>
#define AITask_Callback_FUN_004029f0 ((bool32 (__cdecl* )(AITask* aiTask, LegoObject* liveObj))0x004029f0)

// <LegoRR.exe @00402a10>
#define AITask_Block_FUN_00402a10 ((void (__cdecl* )(const Point2I* blockPos, sint32 param_2))0x00402a10)
...
// param_2 is a Search struct (const Point2I* blockPos, undefined4 field_4)
// <LegoRR.exe @00402ae0>
#define AITask_Callback_FUN_00402ae0 ((bool32 (__cdecl* )(AITask* aiTask, const Point2I* const* search))0x00402ae0)

// param_2 is a Search struct (const Point2I* blockPos, undefined4 field_4)
// <LegoRR.exe @00402b50>
#define AITask_Callback_FUN_00402b50 ((bool32 (__cdecl* )(AITask* aiTask, const Point2I* const* search))0x00402b50)

// param_2 is a Search struct (const Point2I* blockPos, undefined4 field_4)
// <LegoRR.exe @00402ba0>
#define AITask_Callback_FUN_00402ba0 ((bool32 (__cdecl* )(AITask* aiTask, const Point2I* const* search))0x00402ba0)

// param_2 is a Search struct (const Point2I* blockPos, undefined4 field_4)
// <LegoRR.exe @00402bd0>
#define AITask_Callback_FUN_00402bd0 ((bool32 (__cdecl* )(AITask* aiTask, const Point2I* const* search))0x00402bd0)
...
// <LegoRR.exe @00403410>
#define AITask_DoAttackPath ((void (__cdecl* )(const Point2I* blockPos))0x00403410)
...
// <LegoRR.exe @00403630>
#define AITask_FUN_00403630 ((void (__cdecl* )(sint32 param_1, sint32 param_2, sint32 param_3, sint32 param_4))0x00403630)

// <LegoRR.exe @00403680>
#define AITask_DoRequest_ObjectType ((void (__cdecl* )(LegoObject_Type objType, sint32 objLevel, sint32 objID, const Point2I* blockPos, undefined4 param_5, OPTIONAL const Point2F* pointFloat, bool32 param_7))0x00403680)

// <LegoRR.exe @00403740>
#define AITask_PlaceRequestObject ((void (__cdecl* )(const Point2I* blockPos, LegoObject_Type objType, sint32 objID, sint32 objLevel))0x00403740)

// <LegoRR.exe @004037f0>
#define AITask_DoDeposit_ObjectType ((AITask* (__cdecl* )(LegoObject* liveObj, LegoObject_Type objType, sint32 objID, sint32 objLevel))0x004037f0)
...
// <LegoRR.exe @00403eb0>
#define AITask_QSortCompare ((sint32 (__cdecl* )(void* task_a, void* task_b))0x00403eb0)
...
// <LegoRR.exe @004041b0>
#define AITask_LiveObject_Callback_DoAITask ((bool32 (__cdecl* )(LegoObject* liveObj, real32* param_2))0x004041b0)

// <LegoRR.exe @00404d30>
#define AITask_LiveObject_FUN_00404d30 ((bool32 (__cdecl* )(LegoObject* in_liveObj, real32* param_2, real32* param_3))0x00404d30)

// <LegoRR.exe @00404e00>
#define AITask_LiveObject_FUN_00404e00 ((bool32 (__cdecl* )(LegoObject* liveObj))0x00404e00)

// <LegoRR.exe @00404e40>
#define AITask_FUN_00404e40 ((bool32 (__cdecl* )(LegoObject_Type objType, sint32 objID, sint32 objLevel))0x00404e40)
