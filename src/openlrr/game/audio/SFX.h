...
flags_scoped(SFX_GlobFlags) : uint32 // [LegoRR/SFX.c|flags:0x4|type:uint] SFX_GlobFlags
{
    ...
    SFXGLOB_FLAG_SOUNDON      = 0x1,
    SFXGLOB_FLAG_POPULATEMODE = 0x2,
    SFXGLOB_FLAG_UNK_8        = 0x8,
};
...
#define SFX_RegisterName(k)		(sfxGlobs.hashNameList[k]=Gods98::Util_HashString(#k,false,true))
