...
// <LegoRR.exe @0044ca50>
#define LightEffects_SetDisabled ((void (__cdecl* )(bool32 isDisabled))0x0044ca50)
...
// <LegoRR.exe @0044d510>
#define LightEffects_UpdateBlink_FlipSign ((void (__cdecl* )(IN OUT real32* value))0x0044d510)
