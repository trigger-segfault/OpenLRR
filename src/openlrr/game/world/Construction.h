...
// <LegoRR.exe @00408d40>
#define Construction_FUN_00408d40 ((sint32 (__cdecl* )(BlockConstruction* param_1, LegoObject_Type objType, sint32 objID))0x00408d40)

// <LegoRR.exe @00408d80>
#define Construction_SpawnCarryableObject ((void (__cdecl* )(const Point2I* blockPos, LegoObject_Type objType, sint32 objID, sint32 objLevel, uint32 count))0x00408d80)

// <LegoRR.exe @00408df0>
#define Construction_FUN_00408df0 ((void (__cdecl* )(const Point2I* blockPos, const Point2I* shapePoints, uint32 shapeCount))0x00408df0)

// <LegoRR.exe @00408fd0>
#define Construction_BlockCheck_FUN_00408fd0 ((bool32 (__cdecl* )(const Point2I* blockPos))0x00408fd0)

// <LegoRR.exe @00408ff0>
#define Construction_BlockCheck_FUN_00408ff0 ((BlockConstruction* (__cdecl* )(OPTIONAL const Point2I* blockPos, OPTIONAL const sint32* param_2))0x00408ff0)
...
// <LegoRR.exe @004091a0>
#define Construction_LiveObject_DoBlockStructD4_Callbacks_FUN_004091a0 ((bool32 (__cdecl* )(BlockConstruction* param_1))0x004091a0)

// <LegoRR.exe @004091c0>
#define Construction_LiveObject_Callback_FindIn_BlockStructD4Table ((bool32 (__cdecl* )(LegoObject* liveObj, BlockConstruction* data))0x004091c0)

// <LegoRR.exe @00409230>
#define Construction_LayPath ((bool32 (__cdecl* )(const Point2I* blockPos))0x00409230)

// <LegoRR.exe @00409280>
#define Construction_CreateBlock ((BlockConstruction* (__cdecl* )(const Point2I* blockPos))0x00409280)
...
// <LegoRR.exe @00409480>
#define Construction_FUN_00409480 ((void (__cdecl* )(BlockConstruction* construct))0x00409480)

// <LegoRR.exe @00409530>
#define Construction_Cancel ((void (__cdecl* )(const Point2I* blockPos))0x00409530)

// <LegoRR.exe @004096c0>
#define Construction_Start ((sint32 (__cdecl* )(sint32 objID, const Point2I* blockPos, Direction direction, const Point2I* shapePoints, uint32 shapeCount))0x004096c0)
...
// <LegoRR.exe @00409920>
#define Construction_Free ((void (__cdecl* )(BlockConstruction* param_1))0x00409920)

// <LegoRR.exe @00409970>
#define Construction_FUN_00409970 ((void (__cdecl* )(BlockConstruction* param_1))0x00409970)

// <LegoRR.exe @004099c0>
#define Construction_AddShape_FUN_004099c0 ((LegoObject* (__cdecl* )(uint32 param_1, const Point2I* blockPos, Direction param_3, const Point2I* shapePoints, uint32 shapeCount, bool32 teleportDown))0x004099c0)

// <LegoRR.exe @00409a60>
#define Construction_Complete ((LegoObject* (__cdecl* )(BlockConstruction* construct, bool32 teleportDown))0x00409a60)
