...
struct HelpWindow_Globs // [LegoRR/HelpWindow.c|struct:0xd6c|tags:GLOBS]
{
	...
	/*c64,78*/	sint32 unlockedObjIndexes[HELPWINDOW_MAXUNLOCKS];
	/*cdc,78*/	sint32 unlockedObjLevels[HELPWINDOW_MAXUNLOCKS];
...
// <LegoRR.exe @004180e0>
#define HelpWindow_Initialise ((void (__cdecl* )(const Gods98::Config* config, const char* rootPath))0x004180e0)

// <LegoRR.exe @00418380>
#define HelpWindow_LoadLevelsInfo ((void (__cdecl* )(const Gods98::Config* condig, const char* rootPath))0x00418380)

// <LegoRR.exe @00418520>
#define HelpWindow_LoadButtons ((void (__cdecl* )(const Gods98::Config* config, const char* rootPath))0x00418520)

// <LegoRR.exe @00418730>
#define HelpWindow_IfFlag4_AndParam_Clear1_Set2_Else_Clear3 ((void (__cdecl* )(bool32 state))0x00418730)

// <LegoRR.exe @00418760>
#define HelpWindow_RecallDependencies ((void (__cdecl* )(LegoObject_Type objType, sint32 objID, sint32 objLevel, bool32 noHelpWindow))0x00418760)

// <LegoRR.exe @00418850>
#define HelpWindow_Object_Unlock ((void (__cdecl* )(LegoObject_Type objType, sint32 objID, sint32 objLevel))0x00418850)
...
// <LegoRR.exe @00419080>
#define HelpWindow_GetButtonImage ((Image* (__cdecl* )(sint32 buttonIndex))0x00419080)
