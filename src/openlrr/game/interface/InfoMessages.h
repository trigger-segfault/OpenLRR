...
// <LegoRR.exe @00419160>
#define Info_Initialise ((void (__cdecl* )(Font* font))0x00419160)

// <LegoRR.exe @00419310>
#define Info_GetInfoType ((bool32 (__cdecl* )(char* infoName, Info_Type* out_infoType))0x00419310)

// <LegoRR.exe @00419350>
#define Info_GetTypePtr4 ((void* (__cdecl* )(Info_Type infoType))0x00419350)

// <LegoRR.exe @00419360>
#define Info_SetOverFlowImageFile ((void (__cdecl* )(char* filename))0x00419360)
...
// <LegoRR.exe @004193e0>
#define Info_SetTypeText ((void (__cdecl* )(Info_Type infoType, char* text))0x004193e0)
...
// <LegoRR.exe @004195b0>
#define Info_SetTypeSFX ((void (__cdecl* )(Info_Type infoType, SFX_Type sfxType))0x004195b0)
...
// <LegoRR.exe @00419740>
#define Info_LiveObject_Release_internal_FUN_00419740 ((bool32 (__cdecl* )(InfoMessageInstance* instance, SearchInfoObject_8* search))0x00419740)

// <LegoRR.exe @00419760>
#define Info_RemoveAllForObject ((void (__cdecl* )(LegoObject* liveObj))0x00419760)

// <LegoRR.exe @004197f0>
#define Info_Callback_FindBlockPos ((bool32 (__cdecl* )(InfoMessageInstance* infoInstance, SearchInfoBlockPos_8* search))0x004197f0)

// <LegoRR.exe @00419820>
#define Info_RemoveAllAtBlockPos ((void (__cdecl* )(const Point2I* blockPos))0x00419820)

// <LegoRR.exe @004198d0>
#define Info_Callback_FindObjectAndBlockPos ((bool32 (__cdecl* )(InfoMessageInstance* instance, SearchInfoObjectBlockPos_8* search))0x004198d0)
...
// <LegoRR.exe @00419ab0>
#define Info_Send ((void (__cdecl* )(Info_Type infoType, OPTIONAL const char* text, OPTIONAL LegoObject* liveObj, OPTIONAL const Point2I* blockPos))0x00419ab0)
